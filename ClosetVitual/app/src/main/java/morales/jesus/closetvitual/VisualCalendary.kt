package morales.jesus.closetvirtual.ui.calendary
...
data class Prenda(val img: Int)

class VisualCalendaryFragment : Fragment() {
    ...
    inner class PrendaAdapter(private var listaPrendas: List<Prenda> = emptyList()) :
        ...
        override fun onBindViewHolder(holder: PrendaViewHolder, position: Int) {
            ...
            holder.imgPrenda.setImageResource(prenda.img)
            holder.txtNombrePrenda.text = nombresPrendas[prenda.img] ?: "Prenda Desconocida"
        }
